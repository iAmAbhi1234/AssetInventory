...
namespace AssetInventory.Application.AuditLogs.Queries.GetLogsByEntity
{
    ...
    public class GetLogsByEntityQueryHandler : IRequestHandler<GetLogsByEntityQuery, List<AuditLogDto>>
    {
        private readonly IAuditLogRepository _auditLogRepository;

        public GetLogsByEntityQueryHandler(IAuditLogRepository auditLogRepository)
        {
            _auditLogRepository = auditLogRepository;
        }

        public async Task<List<AuditLogDto>> Handle(GetLogsByEntityQuery request, CancellationToken cancellationToken)
        {
